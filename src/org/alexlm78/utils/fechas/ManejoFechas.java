...
public class ManejoFechas 
{
	...
	public static ArrayList<String> getParticiones( int inicio, int fin ) throws Exception
	{
		...
		// Involucra dos a�os distitos, por lo que lo partimos y procesamos recursicamente.
		if ( Integer.parseInt(fAnio) > Integer.parseInt(iAnio) )
		{
	...
	public static ArrayList<ArrayList<Integer>> getFechas( int inicio, int fin ) throws Exception
	{
		...
		if ( Integer.parseInt(fAnio)-Integer.parseInt(iAnio) >= 2 )
			throw new Exception("El periodo de generacion no puede exceder de 2 a�os completos.");
	...
	/**
	 * Obtiene el a�o de una fecha en formato numerico (yyyymmdd).
	 * 
	 * @param fecha Fecha fecha en formato numerico.
	 * @return El mes de la fecha enviada.
	 */
	...
	/**
	 * Obtiene la fecha del ultimo dia del a�o.
	 * 
	 * @param anio A�o a considerar.
	 * @return fecha en numerico del fin de a�o.
	 */
	...
	/**
	 * Obtiene la fecha del primer dia del a�o.
	 * 
	 * @param anio A�o a considerar.
	 * @return fecha en numerico del fin de a�o.
	 */
